...
x2d = [min(goal{goalIndex}(:,1)), max(goal{goalIndex}(:,1))] + GP_plotoffset{goalIndex}(1, 1);
y2d = [min(goal{goalIndex}(:,2)), max(goal{goalIndex}(:,2))] + GP_plotoffset{goalIndex}(1, 2);
...
x3d = [min(goal{goalIndex}(:,1)), max(goal{goalIndex}(:,1))] + GP_plotoffset{goalIndex}(2, 1);
y3d = [min(goal{goalIndex}(:,2)), max(goal{goalIndex}(:,2))] + GP_plotoffset{goalIndex}(2, 2);
