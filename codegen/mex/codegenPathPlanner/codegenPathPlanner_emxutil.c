...
{
  emxFree_real_T(sp, &pStruct->StateInternal);
}
...
void emxInitStruct_navPath(const emlrtStack *sp, navPath *pStruct,
                           const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->StateInternal, 2, srcLocation);
}
...
/* End of code generation (codegenPathPlanner_emxutil.c) */
